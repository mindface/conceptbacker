...
import * as quantify from './data_action/quantify'
...
import * as QuantifyModels from '../../type/quantify'
...
export interface RootStore {
  ...
  quantify: QuantifyModels.initalQuantifyState
}
...
const reducers = combineReducers({
  ...
  quantify: quantify.quantifyReducer
})
